(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ng-connection-service', ['exports', '@angular/core', 'rxjs', '@angular/common/http', 'rxjs/operators'], factory) :
    (global = global || self, factory(global['ng-connection-service'] = {}, global.ng.core, global.rxjs, global.ng.common.http, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    })(exports.HTTP_REQUEST_METHODS || (exports.HTTP_REQUEST_METHODS = {}));
    var DEFAULT_OPTIONS = {
        enableHeartbeat: false,
        heartbeatUrl: DEFAULT_HEART_BEAT_URL,
        heartbeatInterval: DEFAULT_HEART_BEAT_INTERVAL,
        heartbeatRetryInterval: 1000,
        requestMethod: exports.HTTP_REQUEST_METHODS.HEAD
    };
    var ConnectionService = /** @class */ (function () {
        function ConnectionService(http, options) {
            ...
            this.httpSubscription = new rxjs.Subscription();
            this.stateChanged$ = new rxjs.BehaviorSubject(DEFAULT_CONNECTION_STATE);
        ...
        ConnectionService.prototype.checkNetworkState = function () {
            var _this = this;
            this.subscription.add(rxjs.fromEvent(window, 'online').subscribe(function () {
                _this.currentState.hasNetworkConnection = true;
                _this.checkInternetState();
                _this.publishState();
            }));
            this.subscription.add(rxjs.fromEvent(window, 'offline').subscribe(function () {
        ...
        ConnectionService.prototype.checkInternetState = function () {
            var _this = this;
            if (this.serviceOptions.enableHeartbeat) {
                this.subscription = rxjs.interval(3000).pipe(operators.switchMap(function () { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    return __generator(this, function (_a) {
                        return [2 /*return*/, this.http[this.serviceOptions.requestMethod || exports.HTTP_REQUEST_METHODS.HEAD](this.serviceOptions.heartbeatUrl || DEFAULT_HEART_BEAT_URL, { responseType: 'text' }).subscribe({
                                next: function (data) {
       ...
       */
        ...
        ConnectionService.ɵprov = core.ɵɵdefineInjectable({ factory: function ConnectionService_Factory() { return new ConnectionService(core.ɵɵinject(http.HttpClient), core.ɵɵinject(ConnectionServiceOptionsToken, 8)); }, token: ConnectionService, providedIn: "root" });
        ConnectionService = __decorate([
            core.Injectable({
                providedIn: 'root'
            }),
            __param(1, core.Inject(ConnectionServiceOptionsToken)), __param(1, core.Optional())
        ], ConnectionService);
    ...
    exports.DEFAULT_CONNECTION_STATE = DEFAULT_CONNECTION_STATE;
    exports.DEFAULT_HEART_BEAT_INTERVAL = DEFAULT_HEART_BEAT_INTERVAL;
    exports.DEFAULT_HEART_BEAT_RETRY_INTERVAL = DEFAULT_HEART_BEAT_RETRY_INTERVAL;
    exports.DEFAULT_HEART_BEAT_URL = DEFAULT_HEART_BEAT_URL;
